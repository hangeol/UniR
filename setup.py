...
# Further modified by Hangeol Chang in 2025 for the UniR project from https://github.com/huggingface/open-r1/blob/main/setup.py.
...
setup(
    ...
    description="UniR",
    keywords="Universal Reasoner",
    license="Apache",
    url="https://github.com/hangeol/UniR",
    package_dir={"": "src"},
